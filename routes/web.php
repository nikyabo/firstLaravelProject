...
use App\Http\Controllers\HomeController; //import controller
use App\Http\Controllers\GuitarsController; //import controller
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('/',[HomeController::class,'index']) -> name('home.index'); //import the route
